...
/* package haskell-basic-0.1.0.0 */
#ifndef VERSION_haskell_basic
#define VERSION_haskell_basic "0.1.0.0"
#endif /* VERSION_haskell_basic */
#ifndef MIN_VERSION_haskell_basic
#define MIN_VERSION_haskell_basic(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_basic */
...
#define CURRENT_COMPONENT_ID "haskell-basic-0.1.0.0-8J0cqifUR7kAoIas413EOK-haskell-basic"
